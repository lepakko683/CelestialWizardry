...
public class MessageUpdateTileEntityStack
        implements IMessage, IMessageHandler<MessageUpdateTileEntityStack, MessageUpdateTileEntityStack>
{
...
//		if(message.stack != null) {
        ...
        Chunk chunk = FMLClientHandler.instance().getClient().theWorld.getChunkProvider()
                .provideChunk(message.x >> 4, message.z >> 4);
...
//		}
    ...
    public void fromBytes(ByteBuf buf)
    {
        ...
        if (itemName != null && itemName.length() > 0)
        {
            ...
            String item = indx == -1 ? itemName.substring(itemName.indexOf(".") + 1)
                    : itemPrefix + itemName.substring(indx + 1);
