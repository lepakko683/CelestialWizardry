...
public class OBJModels
{
    ...
    //	public static OBJModelBlock modelCrystalContained = new OBJModelBlock(Resources.Models
    // .MODEL_CRYSTAL_CONTAINED);
    public static OBJModelBlock modelCrystalContained = new OBJModelBlock(
            Resources.Models.MODEL_CRYSTAL_CONTAINED_QUADS);
