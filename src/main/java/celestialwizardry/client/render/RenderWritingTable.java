...
public class RenderWritingTable extends TileEntitySpecialRenderer
{
    ...
    public static final ResourceLocation texture = new ResourceLocation("celestialwizardry",
                                                                        "models/writTableTest.png");
//	public static final ResourceLocation texture2 = new ResourceLocation("celestialwizardry",
// "textures/blocks/writingTable_side.png");
