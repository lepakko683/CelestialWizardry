...
public class RenderOreGolem extends RenderLiving
{
    ...
    private static final ResourceLocation oregolemCoal = new ResourceLocation("celestialwizardry",
                                                                              "textures/entity/oregolem/oregolem_coal" +
                                                                                      ".png");
    private static final ResourceLocation oregolemLapis = new ResourceLocation("celestialwizardry",
                                                                               "textures/entity/oregolem/oregolem_lapis.png");
    private static final ResourceLocation oregolemIron = new ResourceLocation("celestialwizardry",
                                                                              "textures/entity/oregolem/oregolem_iron" +
                                                                                      ".png");
    private static final ResourceLocation oregolemGold = new ResourceLocation("celestialwizardry",
                                                                              "textures/entity/oregolem/oregolem_gold" +
                                                                                      ".png");
    private static final ResourceLocation oregolemRedstone = new ResourceLocation("celestialwizardry",
                                                                                  "textures/entity/oregolem/oregolem_redstone.png");
    private static final ResourceLocation oregolemDiamond = new ResourceLocation("celestialwizardry",
