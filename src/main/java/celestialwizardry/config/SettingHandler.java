...
public class SettingHandler
{
    public static void sync()
    {
        ...
        Settings.shiftForDetails = celestibytes.core.reference.Settings.shiftForDetails && CelestialWizardry.config
                .get(category, Settings.ConfigNames.SHIFT_FOR_DETAILS, Settings.DefaultValues.SHIFT_FOR_DETAILS,
