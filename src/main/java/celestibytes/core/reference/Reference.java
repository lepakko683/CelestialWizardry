...
public class Reference
{
    ...
    public static final String GUI_FACTORY_CLASS = "celestibytes.core.config.gui.CbsGuiFactory";

    public static final String FINGERPRINT = "@FINGERPRINT@";

    public static final String DEPENDENCIES = "required-after:Forge@[10.12.1.1110,)";
}
