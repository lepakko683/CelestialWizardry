package celestibytes.core.block;
...
public abstract class BlockBase extends Block
{
    ...
    public BlockBase(String modName)
    {
        this(Material.rock, modName);
    }

    public BlockBase(Material material)
    {
        this(material, Resources.RESOURCE_PREFIX.replace(":", ""));
    }

    public BlockBase(Material material, String modName)
    {
        super(material);
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLiving, ItemStack itemStack)
    {
        if (world.getTileEntity(x, y, z) instanceof TileEntityBase)
        {
            ...
            {
                ((TileEntityBase) world.getTileEntity(x, y, z)).setCustomName(itemStack.getDisplayName());
            }
