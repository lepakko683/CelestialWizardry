...
public abstract class BlockCW extends Block
{
    ...
    {
        return String.format("tile.%s%s", Resources.RESOURCE_PREFIX,
    ...
    {
        if (world.getTileEntity(x, y, z) instanceof TileEntityCW)
        {
            int direction = 0;
            ...
            {
                ((TileEntityCW) world.getTileEntity(x, y, z)).setCustomName(itemStack.getDisplayName());
            }

            ((TileEntityCW) world.getTileEntity(x, y, z)).setOrientation(direction);
        }
    }
