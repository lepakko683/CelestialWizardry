...
import celestibytes.celestialwizardry.client.render.IRenderable;
import celestibytes.celestialwizardry.reference.Names;
import celestibytes.celestialwizardry.reference.Resources;
import celestibytes.celestialwizardry.spellgrammar.ITextContainer;
...
public class ItemPage extends ItemSingle implements IRenderable, ITextContainer
{
    ...
    public void render(double x, double y, double z, Object[] extraData)
    {
        ...
        if (extraData != null)
        {
            ...
            {
                if ((Boolean) extraData[0])
                {//Render on writingTable?
