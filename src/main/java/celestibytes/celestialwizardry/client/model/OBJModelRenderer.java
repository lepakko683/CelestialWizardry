...
import celestibytes.core.util.Loc3DF;
        ...
        if (!this.isHidden)
        {
            if (this.showModel)
            {
                ...
                if (this.rotateAngleX == 0.0F && this.rotateAngleY == 0.0F && this.rotateAngleZ == 0.0F)
                {
                    ...
                    {
                        GL11.glTranslatef(this.rotPoint.getX() * partTick, this.rotPoint.getY() * partTick,
                                          this.rotPoint.getZ() * partTick);
                        GL11.glCallList(this.displayList);
    ...
    public void renderWithRotation(float par1)
    {
        if (!this.isHidden)
        {
            if (this.showModel)
            {
                ...
                GL11.glPushMatrix();
                GL11.glTranslatef(this.rotPoint.getX() * par1, this.rotPoint.getY() * par1,
                                  this.rotPoint.getZ() * par1);
